...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (mysqli_num_rows($result) > 0) {
		...
		$sql = "INSERT INTO intraSummer19 (id, leadersName, leadersEmail, leadersCellnum, leadersDepartment, leadersStudentID, segment ,ip, trxID) 
		VALUES (NULL, '$leadersName', '$leadersEmail', '$leadersCellnum', '$leadersDepartment', '$leadersStudentID', 'FIFA' ,'$ip', '$trxID')";
		if (mysqli_query($db, $sql)) {
            ...
            // $sms_content = "Hello $user, Your Registration for FIFA is successful. Wait for payment confirmation sms";
            // $curl = curl_init();
        ...
        'messageText'=>"Hello $user, Your Registration for FIFA is successful. Wait for payment confirmation sms",
    ...
    <body>
        ...
        <div style="padding:20px;">
            <p>
                <b>Welcome '.$user.',</b>
                <br><br>
                Thank you for getting Registered to the Intra University Tech Carnival Summer-19 | FIFA<br><br><b>Please wait for the Payment confirmation sms</b><br><br>Organized By Robotics Club of BRAC University<br><br>
