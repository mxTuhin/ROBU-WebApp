...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (mysqli_num_rows($result) > 0) {
		...
		VALUES (NULL,'$teamName', '$leadersName', '$leadersEmail', '$leadersCellnum', '$leadersDepartment', '$leadersStudentID', '$mOneName', '$mOneID', '$mOneCellnum', '$mTwoName', '$mTwoID', '$mTwoCellnum', '$mThreeName', '$mThreeID', '$mThreeCellnum', 'Tech Bizz' ,'$ip', '$trxID')";
		if (mysqli_query($db, $sql)) {
            ...
            // $sms_content = "Hello $user, Your Registration for Tech Bizz is successful. Wait for payment confirmation sms";
            // $curl = curl_init();
        ...
        'messageText'=>"Hello $user, Your Registration for Tech Bizz is successful. Wait for payment confirmation sms",
    ...
    <body>
        ...
        <div style="padding:20px;">
            <p>
                <b>Welcome '.$user.',</b>
                <br><br>
                Thank you for getting Registered to the Intra University Tech Carnival Summer-19 | Tech Bizz<br><br><b>Please wait for the Payment confirmation sms</b><br><br>Organized By Robotics Club of BRAC University<br><br>
