      ...
      <div class="container px-4">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-main">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="register/index.php">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Login below to access the ROBU Admin Dashboard.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="index.php" method="post">
                ...
                <div class="text-center">
                  <button id="login_button" type="button" value="submit" class="btn btn-primary my-4">Sign In</button>
                </div>
              </form>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-6">
              <a href="forgotPass/" class="text-light"><small>Forgot password?</small></a>
            </div>
			...
			$("#login_button").click(function () {
			       ...
			       if (Email == "" || Password=="") {
			           Swal.fire({
			               type: 'error',
			               title: 'Oops...',
			               text: 'Email/password field is empty.',
