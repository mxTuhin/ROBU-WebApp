...
<head>
  ...
  <title>ROBU Admin | Rejected Members</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Rejected Members</a>
        <!-- Form -->
...
<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
    ...
    <!-- Content Row -->
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Rejected Members</h6>
	    ...
	    <table  class="table table-striped">
          ...
          <tbody>
            <?php
            $sqlMember = "SELECT * FROM memberInfo WHERE status='rejected' AND joiningSemester='$joiningSemester'";
