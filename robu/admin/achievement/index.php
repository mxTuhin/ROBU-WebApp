...
<head>
  ...
  <title>ROBU Admin | Add Achievement</title>
  <!-- Favicon -->
        ...
        <div  class="col-12 col-sm-12">
            ...
            <form method="post" action="index.php" enctype="multipart/form-data">
                <div class="row customRow">
                    ...
                    <input class="form-control" name="title" placeholder="Project Title" type="text">
                        
                    </div>
                    <br><br>
                    <div class="col-6 col-sm-12">
                        
                        <textarea class="form-control" name="detail" placeholder="Project Detail" type="text"></textarea>
                        
                    </div>
                    <br><br><br>
                    <div class="col-6 col-sm-12">
                        
                    <input class="form-control" name="year" placeholder="Achievement Year" type="text">
                        
                    </div>
                    <br><br>
                    <div class="col-6 col-sm-12">
                        
                    <input class="form-control" name="type" placeholder="Project Type" type="text">
                        
                    </div>
                    <br><br>
                    <div class="col-6 col-sm-12">
                        
                    <input class="form-control" name="teamName" placeholder="Team Name" type="text">
                    ...
                    <br><br>
                    <div style="text-align:center" class="col-6 col-sm-12">
                        
                    <input name="add_achievement" class="btn btn-info" value="Submit Achievement" type="submit">    
                    </div>
                </div>
            </form>
        </div>
