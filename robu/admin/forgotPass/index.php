...
<head>
  ...
  <title>ROBU Admin | Forgot Password</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Provide Email to Recover Password.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form">
                ...
                <div class="text-center">
                  <button id="forgotPass_button" type="button" class="btn btn-primary my-4">Recover Pass</button>
                </div>
              </form>
            </div>
          </div>
