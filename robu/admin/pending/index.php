...
<head>
  ...
  <title>ROBU Admin | Pending Members</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Pending Members</a>
        <!-- Form -->
    ...
    <!-- Content Row -->
	    ...
	    <table  class="table table-striped">
          ...
          <tbody>
            <?php
            $sqlMember = "SELECT * FROM memberInfo WHERE status='pending' AND joiningSemester='$joiningSemester'";
