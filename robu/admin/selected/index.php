...
<head>
  ...
  <title>ROBU Admin | Selected Members</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Selected Members</a>
        <!-- Form -->
    ...
    <!-- Content Row -->
    <!--<div align="center" style="width:100% !important" class="container">-->
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Selected Members</h6>
	    ...
	    <table  class="table table-striped">
          ...
          <tbody>
            <?php
            $sqlMember = "SELECT * FROM memberInfo WHERE status='selected' AND joiningSemester='$joiningSemester' order by robuDepartment";
            ...
            ?>
                <tr id="<?php echo $dataM['id'] ?>">
                  ...
                  <td><div align="center"><?php echo $dataM['robuDepartment']; ?></div></td>
