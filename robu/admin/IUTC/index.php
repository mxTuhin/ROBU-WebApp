...
$sessionEmail=$_SESSION['email'];
    ...
    $resultForRegisteredUser=mysqli_query($db,"SELECT count(*) as total from intraSummer19");
    $dataForRegisteredUser=mysqli_fetch_assoc($resultForRegisteredUser);
    
    $resultForSelectedUser=mysqli_query($db,"SELECT count(*) as total from intraSummer19 WHERE trxID LIKE '6G%'");
    $dataForSelectedUser=mysqli_fetch_assoc($resultForSelectedUser);
    
    $resultForPendingUser=mysqli_query($db,"SELECT count(*) as total from intraSummer19 WHERE trxID=''");
    $dataForPendingUser=mysqli_fetch_assoc($resultForPendingUser);
    
    $resultForInterviewedUser=mysqli_query($db,"SELECT count(*) as total from intraSummer19 WHERE trxID NOT LIKE '6G%'");
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../IUTC/">
              <i style="color:black" class="fas fa-robot"></i></i> IUTC
            </a>
          </li>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Registered Contestants</a>
        <!-- Form -->
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Hand to Hand Payment</h5>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">bKash Payment</h5>
	    ...
	    <table  class="table table-striped">
          <thead>
            <tr>
              ...
              <th scope="col"><div align="center">Team Name</div></th>
              <th scope="col"><div align="center">Leaders Name</div></th>
              ...
              <th scope="col"><div align="center">Segment</div></th>
          ...
          <tbody>
            <?php
            $sqlMember = "SELECT * FROM intraSummer19 order by segment ASC";
            ...
            ?>
                <tr>
                  ...
                  <td><div align="center"><?php echo $dataM['teamName']; ?></div></td>
                  <td><div align="center"><?php echo $dataM['leadersName']; ?></div></td>
                  
                  <td><div align="center"><?php echo $dataM['leadersEmail']; ?></div></td>

                  <td><div align="center"><?php echo $dataM['leadersCellnum']; ?></div></td>
                  <td><div align="center"><?php echo $dataM['leadersDepartment']; ?></div></td>
                  <td><div align="center"><?php echo $dataM['segment']; ?></div></td>
        ...
        <!-- /.container-fluid -->
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Confirmation Pending</h6>
	    ...
	    <table  class="table table-striped">
          <thead>
            <tr>
              ...
              <th scope="col"><div align="center">Email</div></th>
              <th scope="col"><div align="center">Cell Number</div></th>
              <th scope="col"><div align="center">TrxID</div></th>
              <th scope="col"><div align="center">Segment</div></th>
              <th scope="col"><div align="center">Action</div></th>
          ...
          <tbody>
            <?php
            $sqlMember = "SELECT * FROM intraSummer19 where checked='' order by segment ASC";
            $resultMember = mysqli_query($db, $sqlMember);
            $i = 1;
            while($dataM = mysqli_fetch_assoc($resultMember)){
            ?>
                <tr id="<?php echo $dataM['id'] ?>">
                  ...
                  <td><div align="center"><?php echo $dataM['leadersCellnum']; ?></div></td>
                  <td><div align="center"><b><?php echo $dataM['trxID']; ?></b></div></td>
                  <td><div align="center"><?php echo $dataM['segment']; ?></div></td>
                  <td align="center">  <div  style="width:70px">  
                            <div style="float:right"><button id="confirm_button" onclick="confirm_row('<?php echo $dataM['id'] ?>', '<?php echo $dataM['leadersName'] ?>', '<?php echo $dataM['segment'] ?>', '<?php echo $dataM['leadersCellnum'] ?>');"   type="button"  value="submit"  class="btn btn-primary btn-sm">Confirm</button></div>
                            
                            <!--data-toggle="modal" data-target="#myModalDepRemoveDepartment"-->
  ...
  <script type="text/javascript">
            function confirm_row(id, name, segment, cellnum) {
                var rowID="#"+id;
