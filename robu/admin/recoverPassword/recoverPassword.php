...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$hash = $_POST['hash'];
	$sql    = "SELECT * FROM adminInfo WHERE hash='$hash'";
	...
	if($passOne != $passTwo){
		...
		$sqlIP    = "UPDATE adminInfo SET safetyIP='$ip' WHERE hash='$hash'";
	...
	$sql    = "UPDATE adminInfo SET password='$password', hash='$updateHash' WHERE hash='$hash'";
	$result = mysqli_query($db, $sql);
