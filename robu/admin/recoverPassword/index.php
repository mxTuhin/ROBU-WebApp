...
$sql    = "SELECT * FROM adminInfo WHERE hash='$hash' AND email='$email'";
...
<head>
  ...
  <title>ROBU Admin | Recover Password</title>
  <!-- Favicon -->
      ...
      <div class="container px-4">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-main">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="../registration/">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Provide Password to recover account.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
              ...
              <form role="form">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" id="passOne" placeholder="Enter your Password" type="password">
                  </div>
                </div>
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" id="passTwo" placeholder="Enter your Password again" type="password">
                  </div>
                </div>
                
                <div class="text-center">
                  <button id="recover_button" type="button" class="btn btn-primary my-4">Change Password</button>
                </div>
              </form>
            </div>
            <?php
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <center><b>The Link has been expired</b></center>
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="../" class="text-light"><small>Have an account? Login</small></a>
            </div>
            <div class="col-6 text-right">
              <a href="../registration/" class="text-light"><small>Create new account</small></a>
            </div>
          </div>
        </div>
      </div>
