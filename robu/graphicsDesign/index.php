...
$result=mysqli_query($db,"SELECT count(*) as total from graphicsdesign");
...
<head>
  ...
  <title>ROBU | Graphics Design</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Fill up the required info and get registered to the<br> Graphics Design Workshop Fall 19 </p>
            </div>
          </div>
        </div>
      </div>
              ...
              <form action="index.php"  method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" placeholder="Name" id="name" name="name" type="text" required autofocus>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" placeholder="Student ID" id="studentID" name="studentID" type="text" required>
                  </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      ...
                      <input class="form-control" placeholder="Cellnumber (Avoid +880. Must be 11 Digit Cell Number)" type="tel" name="cellnum"
                        pattern="[0-9]{11}"
                        required>
<!--                    <input class="form-control" placeholder="Cellnumber"  name="cellnum" type="text" required>-->
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select name="workshopInfo" class="form-control" required>
                      
                      <option disabled selected value="NotSelected">Attended Graphics Designing Workshop Before ?</option>
                      <option value="Yes">Yes</option>
                      <option value="No">No</option>
                ...
                <div class="text-center">
                  ...
                  <input type="submit" name="registerAdmin" value="Get Registered" class="btn btn-primary mt-4">
                </div>
              </form>
            </div>
	...
	<div id="notfound">
		<div class="notfound">
			<div class="notfound-404">
				<h1>403</h1>
				<h2>Sorry. Seat Limit Exceeded<br> Registration is Over</h2>
			</div><br><br>
			<a style="margin-top:100px" href="../index.php">Go To ROBU Webpage</a>
		</div>
	</div>
